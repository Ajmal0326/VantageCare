  ...
  try {
    ...
    return (
        <SafeAreaView style={styles.mainContainer}>
            ...
            <View style={{ paddingHorizontal: wp(5),flex:1,justifyContent:'center' }}>
                ...
                <View style={styles.tableHeader}>
                    ...
                    <Text style={styles.tableHeaderText}>Hours work</Text>
                ...
                <View style={styles.tableRow}>
                    ...
                    <Text style={styles.tableRowText}>8hr</Text>
                    <Text style={styles.tableRowText}>Approved</Text>
                </View>
                ...
                <Text style={styles.totalHours}>Total working hours: 14 hr</Text>
<TouchableOpacity style={styles.primaryBtn}>
          <Text style={styles.text}>Submit TimeSheet</Text>
        </TouchableOpacity>
